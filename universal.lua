...
if not isfile('vape/Render/Libraries/renderfunctions.lua') then 
	local success, response = pcall(function()
		return game:HttpGet('https://raw.githubusercontent.com/Gvuj/renderWL-/main/renderfunctions.lua')
	end)
	if success then
...
do
	...
	task.spawn(function()
		...
		whitelistloaded = pcall(function()
			WhitelistFunctions.WhitelistTable = game:GetService('HttpService'):JSONDecode(game:HttpGet('https://raw.githubusercontent.com/Gvuj/renderWL-/'..RenderFunctions:GithubHash('VapeV4ForRoblox', 'Gvuj')..'/PlayerWhitelist.json', true))
		end)
